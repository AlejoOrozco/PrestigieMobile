...
export function CategoryCard({
  ...
  return (
    ...
    >
      <Card className="group relative flex flex-col overflow-hidden border-[#c9a882]/30 bg-white/[0.03] p-1.5 transition-transform duration-200 active:scale-[0.98] sm:p-2 md:p-3 md:hover:-translate-y-0.5 md:hover:shadow-[0_0_0_1px_rgba(201,168,130,0.4),0_30px_90px_-40px_rgba(201,168,130,0.45)]">
        ...
        <div className="relative flex flex-col gap-1 sm:gap-2">
          <div className="relative mx-auto w-full max-w-[min(100%,200px)] overflow-hidden rounded-lg border border-white/[0.08] bg-[#0a0a0a] shadow-[inset_0_0_0_1px_rgba(201,168,130,0.14)] sm:max-w-[min(100%,280px)] sm:rounded-xl md:max-w-[min(100%,320px)]">
            <div className="relative aspect-[16/9] w-full sm:aspect-[16/10]">
              <img
                src={imageSrc}
                alt={imageAlt}
                loading="lazy"
